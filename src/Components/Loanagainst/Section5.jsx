...
import loanagainstmob from "../images/loanagainstmob.png";
import loanres from "../images/loanres.jpg";
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 px-0">
      <h1 className="text-center text-3xl font-bold mb-8 text-[#0F1258] px-4 md:px-0">
        What steps should I take to apply <br /> for
        <span className="text-[#1CA43E]"> Loan against property</span>
      </h1>
