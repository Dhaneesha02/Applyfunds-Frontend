  ...
  return (
    <div className="px-4 py-2 mx-auto max-w-[1500px] md:px-12 lg:px-16 lg:py-10">
      ...
      >
        ...
        {/* Image Section */}
        <div className="w-full lg:w-1/4 sm:w-full sm:h-auto sm:mx-auto">
          <img
            className="object-cover w-72 h-82 sm:h-80 lg:h-[350px] rounded-xl mx-auto"
            src={two}
            alt="Loan Services"
          />
        </div>
