...
// const Section9 = (props, ref) => {
//   const [borrowAmount, setBorrowAmount] = useState(5000000); // ₹50 lakhs default
//   const [apr, setApr] = useState(7.5); // default interest rate
//   const [paymentPeriod, setPaymentPeriod] = useState(20); // default 20 years
...
const Section9 = forwardRef((props, ref) => {
  const [borrowAmount, setBorrowAmount] = useState(5000000);
    ...
    >
      <div className="text-center mb-6">
        <h1 className="text-3xl font-bold text-[#0F1258]">
          Home Loan <span className="text-[#1ca43e]">EMI Calculator</span>
        </h1>
      </div>
